...
function ProjetList({ project }: ProjectListProps) {
  ...
  return (
    <>
      <div
        key={project.id}
        className="gap-2 flex items-center border-b border-gray-300 dark:border-gray-500 last:border-none last:rounded-b-2xl hover:bg-gray-100 dark:bg-gray-900/90 dark:hover:bg-gray-800/70"
      >
        <div
          ...
          <>
            <div className="relative">
              <Dropdown
                id={project.id}
                classNameButton={
                  "h-8 text-lg md:text-xl lg:text-2xl sm:mr-2 lg:mr-8 hover:bg-gray-300 dark:hover:bg-gray-700 dark:bg-gray-800"
                }
